function runButtonClickHandler(hObject,~,~)
...
%   Detailed explanation goes here
    ...
    if strcmp(handles.datfilepath,'') || strcmp(handles.eventdirpath,'') ||...
            strcmp(handles.outdirpath,'')
        return
    end
    ...
    guidata(hObject,handles);
    try
        MatlabCntAverager(handles.datfilepath,[handles.eventdirpath,filesep],[handles.outdirpath,filesep],...
